-- 1️⃣ Создаём базу данных (если она ещё не существует)
CREATE DATABASE IF NOT EXISTS susak_test_base;

-- 2️⃣ Выбираем базу данных, в которой будут выполняться все последующие операции
USE susak_test_base;

-- 3️⃣ Отключаем проверку внешних ключей, чтобы можно было удалить таблицы, на которые ссылаются другие таблицы
SET FOREIGN_KEY_CHECKS = 0;


-- 1️⃣ Устанавливаем максимальное время выполнения запросов (0 = бесконечно долго)
SET SESSION max_execution_time = 0;

-- 2️⃣ Устанавливаем кодировку клиента (utf8mb4 — поддерживает все символы, включая эмодзи)
SET NAMES 'utf8mb4';

-- 3️⃣ Устанавливаем тайм-аут ожидания блокировок (50 секунд по умолчанию)
...
-- 5️⃣ Включаем проверку внешних ключей обратно
